...
export interface OperationsCafeApi {
  ...
  generateDealConfirmationPreview: (id: string, draftInput?: unknown) => Promise<DealConfirmationDetail | null>;
  issueDealConfirmation: (id: string, draftInput?: unknown) => Promise<DealConfirmationDetail | null>;
...
const api: OperationsCafeApi = {
  ...
  generateDealConfirmationPreview: (id, draftInput) => ipcRenderer.invoke(IPC_CHANNELS.generateDealConfirmationPreview, { id, draftInput }) as Promise<DealConfirmationDetail | null>,
  issueDealConfirmation: (id, draftInput) => ipcRenderer.invoke(IPC_CHANNELS.issueDealConfirmation, { id, draftInput }) as Promise<DealConfirmationDetail | null>,
