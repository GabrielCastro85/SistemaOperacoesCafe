...
type ThemeOrganizationInput = Pick<
  Organization,
  "slug" | "displayName" | "appDisplayName" | "logoPath" | "primaryColor" | "secondaryColor" | "accentColor"
>;

export function buildUiTheme(variant: AppVariant, organization?: ThemeOrganizationInput | null): UiTheme {
